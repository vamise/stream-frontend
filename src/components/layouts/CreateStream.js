...
const CreateStream = (props) => {
    ...
    const stepContent = [ <
        ...
        /Option> < /
        Select > <
        /Form.Item> { / * < Row justify = "space-around" > * / } <
        Form.Item
        ...
        disabled = { true }
        placeholder = {
            (range !== undefined) ? amount * (range[1].unix() - range[0].unix()) : 0
        }
        ...
        label = "Start Time - End Time" {...rangeConfig } >
        <
        RangePicker
        showTime
        value = { range }
        ...
        selector.result ? ( <
            ...
            subTitle = "Please check and modify the information and try again."
            extra = {
                [ <
                    Button
                    type = "primary"
    ...
    return ( <
        ...
        h3 > <
        /Col> <
        div className = "create-stream-steps"
        style = {
            {
                width: "100%",
                height: "80vh",
        ...
        <
        /Steps> <
        Content className = "form-content" > { stepContent[currentStep] } <
        /Content> < /
        div > <
        /div>
    );
