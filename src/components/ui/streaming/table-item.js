...
const Tableitem = ({
    ...
    return ( <
        ...
        h3 className = "item-heading" > { receiver } < CheckCircleTwoTone / >
        <
        /h3> <
        /Col> <
        Col >
        ...
        h3 className = "item-heading" > { token } < CheckCircleTwoTone / >
        <
        /h3> <
        /Col> <
        Col >
        ...
        Popover title = "Stream Amount(In Lamports)"
        content = { <
            div >
            This is the total amount of Stream tokens,
            <
